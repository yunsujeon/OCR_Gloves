...
while True:
	...
	img_dilated = cv2.dilate(img_removenoize, kernel2, iterations = 4)
	...
	for i in range(nlabels):
		...
		cv2.line(img_color, (350,230),(350,280),(0,255,0),1)
		...
		if m == 0 and top + height < 280 and top + height > 230 and left < 350 and left + width > 350 :
			a = left
			b = top
			c = width
			d = height
			m = 1
		img_cut=img_dilated[200:270,350:353]
		no_white = cv2.countNonZero(img_cut)
		
		if m == 2 and top + height < 280 and top + height > 230 and no_white < 1:
			m=0
	
	

	if m == 1 and b + d < 280 and b + d > 230 and a < 350 and a + c > 350 :
		img_crop = img_binary[b : b + d, a : a + c]
		buf = "/home/jeon/OCR_Gloves/tesseract/img_saves/tesimg%05d.jpg" % (index)
		cv2.imwrite(buf,img_crop)
		tess = pytesseract.image_to_string(Image.open('/home/jeon/OCR_Gloves/tesseract/img_saves/tesimg%05d.jpg' % (index)), config=' --psm 7')
